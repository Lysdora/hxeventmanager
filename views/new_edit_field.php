...
<table class="form-table">
    <tr valign="top">
        ...
        <td><input name="field_label" type="text" id="field_label" class="regular-text"></td>
    </tr>
    <tr valign="top">
        <th scope="row"><label for="field_description">Field Description</label></th>
        <td><input name="field_description" type="text" id="field_description" value="" class="regular-text">
        <p class="description">If the field needs explanation, enter that here. It will show in the form as a hint underneath the input element.</p></td>
    </tr>
<tr>
    ...
    <tr valign="top" id="field_options_row" style="display: none;">
        ...
        <td><textarea name="field_options" cols="39" rows="5" id="field_options"></textarea>
    ...
    <tr valign="top" id="field_checkbox_label_row" style="display: none;">
        ...
        <td>
            <input name="field_checkbox_label" type="text" id="field_checkbox_label" class="regular-text">
    ...
    <td>
        <fieldset>
            ...
            <label for="field_required">
                <input name="field_required" type="checkbox" id="field_required" value="1"> Yes
            </label>
    ...
    <td>
        <fieldset>
            ...
            <label for="field_active">
                <input name="field_active" type="checkbox" id="field_active" value="1" checked> Yes
            </label>
        </fieldset>
    </td>
</tr>
